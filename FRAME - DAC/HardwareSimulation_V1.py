...
class HardwareSimulation:
    def __init__(self, weights, biases):
        ...
        self.A = []
        self.Gref_W1 = (self.Wmax_1 * self.Gmin - self.Wmin_1 * self.Gmax) / (self.Wmax_1 - self.Wmin_1)
        self.Gref_W2 = (self.Wmax_2 * self.Gmin - self.Wmin_2 * self.Gmax) / (self.Wmax_2 - self.Wmin_2)
        self.Gref_W3 = (self.Wmax_3 * self.Gmin - self.Wmin_3 * self.Gmax) / (self.Wmax_3 - self.Wmin_3)
        self.Gref_list = [self.Gref_W1, self.Gref_W2, self.Gref_W3]
        ...
        self.B0_1 = (self.Gmax - self.Gmin) / (self.Bmax_1 - self.Bmin_1)
        self.B0_2 = (self.Gmax - self.Gmin) / (self.Bmax_2 - self.Bmin_2)
        self.B0_3 = (self.Gmax - self.Gmin) / (self.Bmax_3 - self.Bmin_3)
        self.B0_list = [self.B0_1, self.B0_2, self.B0_3]
        self.Gref_B1 = (self.Bmax_1 * self.Gmin - self.Bmin_1 * self.Gmax) / (self.Bmax_1 - self.Bmin_1)
        self.Gref_B2 = (self.Bmax_2 * self.Gmin - self.Bmin_2 * self.Gmax) / (self.Bmax_2 - self.Bmin_2)
        self.Gref_B3 = (self.Bmax_3 * self.Gmin - self.Bmin_3 * self.Gmax) / (self.Bmax_3 - self.Bmin_3)
        self.Bref_list = [self.Gref_B1, self.Gref_B2, self.Gref_B3]

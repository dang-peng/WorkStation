...
from HardwareSimulation import HardwareSimulation
...
for epoch in range(num_epochs):
    ...
    print("Epoch: {}  Loss: {:.2f}  Train Accuracy: {:.2f}  Test Accuracy: {:.2f}  Test Accuracy Binary: {:.2f}  "
          "Test Accuracy Hardware: {:.2f}".format(epoch + 1, Loss[epoch], train_accuracy, test_accuracy,
                                                  test_accuracy_binary, test_accuracy_hardware))

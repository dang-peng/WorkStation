...
# UsingHardwareTest4 = UsingHardwareInferenceVth1.Test_Hardware(Test_times, test_images, test_labels)
# UsingHardwareTest5 = UsingHardwareInferenceVth2.Test_Hardware(Test_times, test_images, test_labels)
UsingHardwareTest7 = UsingHardwareInferenceVth3.Test_Hardware(Test_times, test_images, test_labels)
...
filename1 = "./inference_data_Vth_test7.pickle"
with open(filename1, 'wb') as file:
    pickle.dump((TestNumber,  UsingHardwareTest7), file)
plt.rcParams['mathtext.fontset'] = 'stix'
plt.plot(TestNumber, UsingHardwareTest7, linewidth = 3,

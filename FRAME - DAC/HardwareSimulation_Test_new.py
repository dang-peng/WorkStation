...
SoftwareInferenceBinaryTest = []
UsingHardwareTest = []
TestNumber = []
for i in range(Test_times):
    print("{}th Testing...".format(i))
    TestNumber.append(i)
    test_accuracy_software = SoftwareInference.test(test_images[84:85], test_labels[84:85])
    SoftwareInferenceTest.append(test_accuracy_software)
    print("Software Inference Test Accuracy: {:.2f}".format(test_accuracy_software))
    test_accuracy_software_binary = SoftwareInference.test_binary(i + 1, test_images[84:85], test_labels[84:85])
    SoftwareInferenceBinaryTest.append(test_accuracy_software_binary)
    print("Software Inference Binary Test Accuracy: {:.2f}".format(test_accuracy_software_binary))
    test_accuracy_hardware = UsingHardwareInference.Test_Hardware(i + 1, test_images[84:85], test_labels[84:85])
    UsingHardwareTest.append(test_accuracy_hardware)
    print("Using Hardware Inference Test Accuracy: {:.2f}".format(test_accuracy_hardware))
plt.plot(TestNumber, SoftwareInferenceTest, linewidth = 2, label = 'Software Inference')
plt.plot(TestNumber, SoftwareInferenceBinaryTest, linewidth = 2, label = 'Binary Software Inference')
plt.plot(TestNumber, UsingHardwareTest, linewidth = 2, label = 'Using Hardware Inference')

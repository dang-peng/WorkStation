...
class HardwareSimulation:
    def __init__(self, Vth, weights, biases):
        self.Wmin_1 = -0.4
        self.Wmax_1 = 0.4
        self.Wmin_2 = -0.5
        self.Wmax_2 = 0.5
...
Vth2 = 0.05
Vth3 = 0.3
UsingHardwareInferenceVth1 = HardwareSimulation(Vth1, weights, biases)
UsingHardwareInferenceVth2 = HardwareSimulation(Vth2, weights, biases)
UsingHardwareInferenceVth3 = HardwareSimulation(Vth3, weights, biases)
SoftwareBinaryTest = SoftwareInference.test_binary(Test_times, test_images, test_labels)
UsingHardwareTest1 = UsingHardwareInferenceVth1.Test_Hardware(Test_times, test_images, test_labels)
UsingHardwareTest2 = UsingHardwareInferenceVth2.Test_Hardware(Test_times, test_images, test_labels)
UsingHardwareTest3 = UsingHardwareInferenceVth3.Test_Hardware(Test_times, test_images, test_labels)
...
filename1 = "./inference_data_1.pickle"
...
plt.plot(TestNumber, SoftwareInferenceTest, linewidth = 2, label = 'Software Inference')
plt.plot(TestNumber, SoftwareBinaryTest, linewidth = 2, label = 'Binary Software Inference')
plt.plot(TestNumber, UsingHardwareTest1, linewidth = 2, label = 'Hardware Inference' + ' Vth = {} V'.format(Vth1))
plt.plot(TestNumber, UsingHardwareTest2, linewidth = 2, label = 'Hardware Inference' + ' Vth = {} V'.format(Vth2))
plt.plot(TestNumber, UsingHardwareTest3, linewidth = 2, label = 'Hardware Inference' + ' Vth = {} V'.format(Vth3))
plt.legend(prop = {'family': 'Times New Roman'}, loc = 'lower right')
plt.xlabel('Test Times', fontname = "Times New Roman", fontsize = 14, color = 'black')
plt.ylabel('Accuracy', fontname = "Times New Roman", fontsize = 14, color = 'black')

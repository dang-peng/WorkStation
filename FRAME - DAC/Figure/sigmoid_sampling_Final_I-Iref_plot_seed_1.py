...
plt.plot(Num_Sampling_list, V_list, '#2CA02C', linewidth = 2, label = 'I')
...
plt.plot(Num_Sampling_list, np.array(V_list) - np.array(Vref_list), '#1B9C85', linewidth = 2, label = 'I - Iref')
plt.xlim(0, 100)
# plt.ylim(0.7, 0.85)
plt.xlabel('')
plt.ylabel('I - Iref [\u03BCA]', fontname = "Times New Roman", fontsize = 14, color = 'black')
...
filename = f"sigmoid_Sample_I_Iref_0.745_{current_time}.svg"

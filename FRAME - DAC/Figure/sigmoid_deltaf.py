...
print("a1 = ", a1)
print("Vr1 = ", Vr1)
a2 = Vr * G0 / np.sqrt(4 * N2 * rows * Gref)
Vr2 = a2 * np.sqrt(4 * N2 * rows * Gref) / G0
print("a2 = ", a2)
print("Vr2 = ", Vr2)
a3 = Vr * G0 / np.sqrt(4 * N3 * rows * Gref)
Vr3 = a3 * np.sqrt(4 * N3 * rows * Gref) / G0
print("a3 = ", a3)
print("Vr3 = ", Vr3)
z_list = []
Y_list = []
...
for n in range(100):
    ...
    z_list.append(z[0][0])
    Y_list.append(y[0][0])
delta_f1 = "{:.1e}".format(delta_f1)
delta_f2 = "{:.1e}".format(delta_f2)
delta_f3 = "{:.1e}".format(delta_f3)
...
Solid_Type = False
if not Solid_Type:
    l1 = plt.scatter(z_list, yb1_list, s = 50, label = r'$\Delta$f = ' + str(delta_f1) + ' Hz', marker = 'o',
                     linewidths = 2)
    l2 = plt.scatter(z_list, yb2_list, s = 50, label = r'$\Delta$f = ' + str(delta_f2) + ' Hz', marker = 'o',
                     linewidths = 2)
    l3 = plt.scatter(z_list, yb3_list, s = 50, label = r'$\Delta$f = ' + str(delta_f3) + ' Hz', marker = 'o',
                     linewidths = 2)
else:
...
filename = f"sigmoid_delta_f_{current_time}.svg"

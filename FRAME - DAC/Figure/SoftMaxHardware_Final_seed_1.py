...
colors1 = ['#FA9994', '#EA9100', '#FAAA6E', '#74BBE9', '#B7C000', '#CAD239', '#AAC32F', '#9EC147', '#4CBFCE', '#D7BBD4']
# colors1 = ['#74BBE9']
colors2 = ['#EFB9BD', '#9EC147', '#CAD239', '#EFB9BD', '#DA6969', '#82629F', '#00A4B9', '#479CD1', '#EC8B2D', '#D32727']
# colors2 = ['#EFB9BD']

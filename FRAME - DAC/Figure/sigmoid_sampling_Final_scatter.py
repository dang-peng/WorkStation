...
for i in range(num_experiment):
    ...
    # if round(yb / num_experiment, 1) == 0.9:
    # yb_list.append(0.9)
    # else:
    # yb_list.append(0)
...
plt.scatter(Num_Sampling_list, V_list, color = '#FF0000', s = 30, label = 'V')
# plt.plot(Num_Sampling_list, V_list, 'r-', linewidth = 2, label = 'V')
plt.xlim(0, 100)
plt.ylim(0.7, 0.85)
plt.ylabel('V,Vref [V]', fontname = "Times New Roman", fontsize = 16, color = 'black')
...
plt.scatter(Num_Sampling_list, Vref_list, color = '#2CA02C', s = 30, label = 'Vref')
...
plt.scatter(Num_Sampling_list, np.array(V_list) - np.array(Vref_list), color = '#2CA02C', s = 30, label = 'Vref')
plt.xlim(0, 100)
# plt.ylim(0.7, 0.85)
plt.xlabel('')
plt.ylabel('V-Vref [V]', fontname = "Times New Roman", fontsize = 16, color = 'black')
...
plt.ylabel('y_b', fontname = "Times New Roman", fontsize = 16, color = 'black')
plt.yticks(fontname = "Times New Roman", fontsize = 16, color = 'black')
plt.legend(prop = {'family': 'Times New Roman'}, loc = 'lower left')
...
filename = f"sigmoid_Sample_0.9_{current_time}.svg"

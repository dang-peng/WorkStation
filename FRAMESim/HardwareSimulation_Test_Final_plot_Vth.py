...
from HardwareSimulation_Test_Final_plot_Vth_2 import UsingHardwareTest6
...
Vth4 = 0.25
Vth3 = 0.3
filename = "inference_data_1.pickle"
with open(filename, 'rb') as file:
    (TestNumber, SoftwareInferenceTest, SoftwareInferenceBinaryTest, UsingHardwareTest1, UsingHardwareTest2,
     UsingHardwareTest3) = pickle.load(file)
plt.rcParams['mathtext.fontset'] = 'stix'
plt.plot(TestNumber, SoftwareInferenceTest, linewidth = 3, label = 'Software Inference')
plt.plot(TestNumber, SoftwareInferenceBinaryTest, linewidth = 3, label = 'Binary Software Inference')
...
plt.plot(TestNumber, UsingHardwareTest6, linewidth = 3,
         label = 'Hardware Inference ' + r'$\mathrm{V}_\mathrm{th0}$' + ' = {} V'.format(Vth4))

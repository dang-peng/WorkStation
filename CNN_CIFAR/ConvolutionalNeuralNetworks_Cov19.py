...
class ConvolutionalNeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.conv16 = nn.Conv2d(512, 256, kernel_size = 3, padding = 1)  # 可选地减少通道数以减少参数量
        self.pool6 = nn.MaxPool2d(kernel_size = 2, stride = 2, padding = 1)  # 通常在接近网络末端时不再增加padding
        self.bn6 = nn.BatchNorm2d(256)
        self.relu6 = nn.ReLU()
        
        self.fc17 = nn.Linear(256 * 3 * 3, 1024)
        self.drop1 = nn.Dropout()
        self.fc18 = nn.Linear(1024, 1024)
        self.drop2 = nn.Dropout()
        self.fc19 = nn.Linear(1024, 10)
    ...
    def Train(self, device):
        ...
        with open(f'./TrainDataCov19/CNN_train_data_{current_time}.pickle', 'wb') as file:
            pickle.dump((Loss, Test_Accuracy), file)
    
    def Test(self, device):
        file_path = './TrainDataCov19/CNN_model_data_epoch_199.tar'
